...
import "./verifier40.sol";
import "../AM.sol";

pragma solidity ^0.8.0;

contract XACMLSmartPolicyMonolithic40Checks {
    ...
    // RULES //
    ///////////
    function evaluateRule_prize_right(address _subject, Verifier40.Proof memory _proofGrade) public view returns(RuleEvaluation) {
    ...
    function evaluate(
        address subject,
        Verifier40.Proof memory _avgGradeProof
    ) public returns(bool) {
