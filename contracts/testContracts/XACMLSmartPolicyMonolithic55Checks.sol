...
import "./verifier55.sol";
import "../AM.sol";

pragma solidity ^0.8.0;

contract XACMLSmartPolicyMonolithic55Checks {
    ...
    // RULES //
    ///////////
    function evaluateRule_prize_right(address _subject, Verifier55.Proof memory _proofGrade) public view returns(RuleEvaluation) {
    ...
    function evaluate(
        address subject,
        Verifier55.Proof memory _avgGradeProof
    ) public returns(bool) {
