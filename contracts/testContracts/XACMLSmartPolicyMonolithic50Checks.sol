...
contract XACMLSmartPolicyMonolithic50Checks {
    ...
    // RULES //
    ///////////
    function evaluateRule_prize_right(address _subject, Verifier50.Proof memory _proofGrade) public view returns(RuleEvaluation) {
    ...
    function evaluate(
        address subject,
        Verifier50.Proof memory _avgGradeProof
    ) public returns(bool) {
