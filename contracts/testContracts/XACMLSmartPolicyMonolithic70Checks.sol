...
import "./verifier70.sol";
import "../AM.sol";

pragma solidity ^0.8.0;

contract XACMLSmartPolicyMonolithic70Checks {
    ...
    // RULES //
    ///////////
    function evaluateRule_prize_right(address _subject, Verifier70.Proof memory _proofGrade) public view returns(RuleEvaluation) {
    ...
    function evaluate(
        address subject,
        Verifier70.Proof memory _avgGradeProof
    ) public returns(bool) {
