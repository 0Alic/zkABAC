...
import "./verifier65.sol";
import "../AM.sol";

pragma solidity ^0.8.0;

contract XACMLSmartPolicyMonolithic65Checks {
    ...
    // RULES //
    ///////////
    function evaluateRule_prize_right(address _subject, Verifier65.Proof memory _proofGrade) public view returns(RuleEvaluation) {
    ...
    function evaluate(
        address subject,
        Verifier65.Proof memory _avgGradeProof
    ) public returns(bool) {
